function lickNoLick_Odor_Laser
    ...
    PulsePalArrayList = {'PulsePal_LNL_Laser', 'PulsePal_Ai32_Laser'};
    defaults = {...
        ...
        'GUIPanels.Blocks', {'BlockFcn', 'PhotometryRasterFcn', 'PulsePalArray', 'Block'};...
        ...
        'GUI.PulsePalArray', 'PulsePal_LNL_Laser';...
        'GUIMeta.PulsePalArray.Style', 'popupmenutext';...
        'GUIMeta.PulsePalArray.String', PulsePalArrayList;...
        'GUI.Block', 1;...
...
%     S.GUI.LED2_f = 0;
 ...
 if S.GUI.UsePulsePal
     try
         PPP = load(S.GUI.PulsePalArray);
         PPP = PPP.(S.GUI.PulsePalArray);
         ProgramPulsePal(PPP);
         disp(['**Loaded PulsePal Program: ' S.GUI.PulsePalArray '***']);
     catch
         PulsePal;
         PPP = load(S.GUI.PulsePalArray);
         PPP = PPP.(S.GUI.PulsePalArray);
    ...
    BpodSystem.Data.TriggerPulsePal = []; % trigger pulse pal
...
%     TrialOutcomes = [];
    ...
    for currentTrial = 1:MaxTrials
        ...
        TriggerPulsePal = S.Block.Table.TriggerPulsePal(TrialType);
        if TriggerPulsePal
            startRecordingWireArg = bitset(npgWireArg, 3);
        else
            startRecordingWireArg = npgWireArg;
        end
       ...
       %% Assemble state matrix
        ...
        sma = AddState(sma,'Name', 'NoLick', ...
            ...
            'OutputActions', {}); % Pulse Pal sound on
        ...
        sma = AddState(sma, 'Name', 'StartRecording',...
            ...
            'OutputActions', {'GlobalTimerTrig', 2, 'BNCState', npgBNCArg, 'WireState', startRecordingWireArg}); % trigger photometry acq global timer, nidaq trigger, point grey camera
        ...
        if ~isempty(fieldnames(RawEvents)) % If trial data was returned
            ...
            BpodSystem.Data.TriggerPulsePal(end + 1) = TriggerPulsePal;
