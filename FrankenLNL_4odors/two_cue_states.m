...
%% block 6 (A&C preceeds B&D, rewarded 100%, 10% uncued rewards)
S = struct(); ST = struct();
ST.BlockNumber = repmat(6, 3, 1); % fluff
ST.P = [...
    0.90*0.5;...
    0.90*0.5;...
    0.10];
ST.CS1 = [4; 2; 0]; % will be used to select S.GUI.Odor1Valve
ST.CS2 = [3; 1; 0]; % will be used to select S.GUI.Odor2Valve
ST.US = {'Reward';'Reward';'Reward'};   % is it Rewarded ?
S.Table = struct2table(ST);
S.LinkTo = 0;
S.LinkToFcn = '';
