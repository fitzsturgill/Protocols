...
% choice (green dot), 2: did not choose (green circle)
    ...
    %     end
        ...
        % if Target == 100ms, it defines a reasonable minimum reaction time below which withdrawals are considered an early withdrawal (i.e. the mouse anticipated the target light rather actually perceiving and responding to it)        
        sma = AddState(sma, 'Name', 'Target', ...
            'Timer', S.GUI.Target,...
            'StateChangeConditions', {'Tup', 'WaitForResponse', 'Port2Out', 'Punish'},... 
