...
xlabel('trial #'); ylabel('ITI'); hold on;
...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'DrinkingLeft', ...
        'Timer', 10,...
        'StateChangeConditions', {'Tup', 'ITI', 'Port1Out', 'ConfirmPortOutLeft'},...
        'OutputActions', {'PWM1', S.GUI.BaselineIntensity + S.GUI.LightIntensity});
    sma = AddState(sma, 'Name', 'ConfirmPortOutLeft', ... 
        'Timer', S.GUI.PortOutRegDelay,...
        'StateChangeConditions', {'Tup', 'ITI', 'Port1In', 'DrinkingLeft'},...
        'OutputActions', {'PWM1', S.GUI.BaselineIntensity + S.GUI.LightIntensity});
    sma = AddState(sma, 'Name', 'DrinkingRight', ...
        'Timer', 10,...
        'StateChangeConditions', {'Tup', 'ITI', 'Port3Out', 'ConfirmPortOutRight'},...
        'OutputActions', {'PWM3', S.GUI.BaselineIntensity + S.GUI.LightIntensity});
    sma = AddState(sma, 'Name', 'ConfirmPortOutRight', ... 
        'Timer', S.GUI.PortOutRegDelay,...
        'StateChangeConditions', {'Tup', 'ITI', 'Port3In', 'DrinkingRight'},...
        'OutputActions', {'PWM3', S.GUI.BaselineIntensity + S.GUI.LightIntensity});
    ...
    if ~isempty(fieldnames(RawEvents)) % If trial data was returned
        ...
        TotalRewardDisplay('add', S.GUI.RewardAmount); % you can't comlete a trial without achieving a reward (if you are a mouse!)
