...
S = struct(); ST = struct();
ST.BlockNumber = [8; 8; 8; 8; 8; 8; 8; 8]; % fluff
ST.P = [0.15; 0.15; 0.1; 0.1; 0.15; 0.15; 0.1; 0.1];
ST.CS = [1; 1; 1; 1; 2; 2; 2; 2]; % GoTone A and NoGoTone B
ST.SoundAmplitude = [40; 30; 20; 15; 40; 30; 20; 15];
ST.CSValence = [1; 1; 1; 1; 1; 1; 1; 1];
ST.Instrumental = [1; 1; 1; 1; 1; 1; 1; 1];
ST.WaterAmount = [8; 8; 8; 8; 0; 0; 0; 0];
ST.US = {'Reward'; 'Reward'; 'Reward'; 'Reward'; 'Punish'; 'Punish'; 'Punish'; 'Punish'};
...
% S.LinkToFcn = '';
% blocks{end + 1} = S;
% % %% block 9 pavlovian with different RPE
% % S = struct(); ST = struct();
% % ST.BlockNumber = [9; 9; 9; 9]; % fluff
% % ST.P = [0.4; 0.2; 0.2; 0.2];
% % ST.CS = [1; 2; 2; 3]; % high reward cue A, low reward cue B, punish cue C and neutral tone D
% % ST.SoundAmplitude = [50; 50; 50; 50];
% % ST.CSValence = [1; 1; 1; 1];
