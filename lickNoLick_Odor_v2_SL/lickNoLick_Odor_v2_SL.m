function lickNoLick_Odor_v2_SL
    ...
    blockFunctionList = {'pavlovian_reversals_blocks', 'pav_rev_blocks_noPunish', 'instrumental_reversals_blocks', 'instrumental_reversals_blocks2', 'expected_uncertainty_SL'};
