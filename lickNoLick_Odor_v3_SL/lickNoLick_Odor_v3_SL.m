function lickNoLick_Odor_v3_SL
    ...
    blockFunctionList = {'pavlovian_reversals_blocks', 'pav_rev_blocks_noPunish', 'instrumental_reversals_blocks', 'instrumental_reversals_blocks2', 'expected_uncertainty_v3_SL'};
    ...
    defaults = {...
        ...
        'GUIPanels.Stimuli', {'PunishValveTime', 'Reward', 'UsePulsePal', 'Odor1Valve', 'Odor2Valve', 'Odor3Valve', 'neutralToneOn', 'TsToneOn'};...
...
%     S.RewardValveTime = GetValveTimes(S.GUI.Reward, S.RewardValveCode);
    ...
    %% Initialize NIDAQ
    S.nidaq.duration = S.PreCsRecording + S.TsTime + S.OdorTime + S.GUI.AnswerDelay + S.GUI.Answer + S.PostUsRecording;
...
%             'OutputActions',{});        
        ...
        sma = AddState(sma,'Name', 'Reward', ... % 4 possible outcome states: Reward (H2O + tone), Punish (air puff + tone), WNoise (white noise), Neutral (tone)
            ...
            'OutputActions', {'ValveState', S.RewardValveCode, 'SoftCode', neutralCode}); % previously 'SoftCode', 1
        sma = AddState(sma,'Name', 'Punish', ...
            'Timer', S.GUI.PunishValveTime,... %
            'StateChangeConditions', {'Tup', 'PostUsRecording'},...
            'OutputActions', {'ValveState', S.PunishValveCode, 'SoftCode', neutralCode});  % previously 'SoftCode', 1
